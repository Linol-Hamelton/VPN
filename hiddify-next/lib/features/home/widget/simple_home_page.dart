              ...
              children: [
                Column(
                  children: [
                    ...
                    const Gap(4),
                    Text(
                      '${(data.downlink / 1024 / 1024).toStringAsFixed(1)} MB/s',
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                    const Gap(4),
                    _buildSpeedIndicator(data.downlink / 10000000.0), // Assuming max 10MB/s for scaling
                ...
                Column(
                  children: [
                    ...
                    const Gap(4),
                    Text(
                      '${(data.uplink / 1024 / 1024).toStringAsFixed(1)} MB/s',
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                    const Gap(4),
                    _buildSpeedIndicator(data.uplink / 10000000.0), // Assuming max 10MB/s for scaling
                ...
                Column(
                  children: [
                    ...
                    const Gap(4),
                    _buildPingIndicator(data.delay / 200.0), // Assuming max 200ms for scaling
                  ],
                ),
              ],
            ),
