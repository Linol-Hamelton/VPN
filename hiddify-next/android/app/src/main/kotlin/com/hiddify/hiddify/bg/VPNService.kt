...
class VPNService : VpnService(), PlatformInterfaceWrapper {
    ...
    /**
     * Add a package to the allowed list (included in VPN)
     */
    fun addIncludePackage(builder: Builder, packageName: String) {
        ...
        try {     
            ...
            Log.e("VpnService", "Package not found: $packageName", e)
        }
    }

    /**
     * Add a package to the disallowed list (excluded from VPN)
     */
