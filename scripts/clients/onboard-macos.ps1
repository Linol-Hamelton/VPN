param(
  ...
  [Parameter(Mandatory=$false)]
  [string]$OutFile = ".\\client-pack-macos.txt"
)
...
$lines.Add("macOS setup (x-ui / XRay, VLESS Reality)")
$lines.Add("")
$lines.Add("1) Install a client app (pick one):")
$lines.Add("- Hiddify (macOS)")
$lines.Add("- sing-box based clients")
$lines.Add("")
...
$lines.Add("")
$lines.Add("3) Connect and approve VPN permissions if prompted.")
$lines.Add("")
$lines.Add("Notes:")
