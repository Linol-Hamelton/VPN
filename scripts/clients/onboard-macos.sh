...
vless_link=""
sub_url=""
out_file="./client-pack-macos.txt"

usage() {
  cat <<'EOF'
Usage:
  ./scripts/clients/onboard-macos.sh [--vless-link "vless://..."] [--subscription-url "https://..."] [--out "./client-pack-macos.txt"]
EOF
}
...
{
  echo "macOS setup (x-ui / XRay, VLESS Reality)"
  echo
  ...
  echo
  echo "3) Connect and approve VPN permissions if prompted."
  echo
  echo "Notes:"
